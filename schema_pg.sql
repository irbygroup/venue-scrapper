...
INSERT INTO config (name, value) VALUES ('litellm_model', 'openrouter/anthropic/claude-haiku-4.5') ON CONFLICT DO NOTHING;
INSERT INTO config (name, value) VALUES ('litellm_fallback_1', 'openrouter/google/gemini-3-flash-preview') ON CONFLICT DO NOTHING;
INSERT INTO config (name, value) VALUES ('litellm_fallback_2', 'openrouter/openai/gpt-5.4-mini') ON CONFLICT DO NOTHING;
